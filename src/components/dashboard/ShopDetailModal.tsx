            ...
            <div className="fixed right-0 top-0 h-full w-full max-w-[520px] z-50 flex flex-col bg-background border-l border-slate-200 dark:border-border/60 shadow-2xl overflow-y-auto animate-slide-in-right">
                ...
                <div className="flex items-start justify-between p-5 border-b border-slate-200 dark:border-border/50 bg-card dark:bg-card/30 backdrop-blur-sm sticky top-0 z-10">
                    <div className="space-y-1">
                        ...
                        <Badge
                            variant="outline"
                            className="text-[10px] px-1.5 py-0.5 h-5 border-emerald-200 dark:border-emerald-500/30 text-emerald-700 dark:text-emerald-550 mt-1 bg-emerald-50/50 dark:bg-transparent"
                        >
                            Active
                        </Badge>
                    </div>
                        ...
                        <>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <MetricCard
                                    ...
                                    iconColor="bg-indigo-50 dark:bg-indigo-500/15 text-indigo-700 dark:text-indigo-400"
                                />
                                <MetricCard
                                    icon={Package}
                                    label="Orders"
                                    ...
                                    iconColor="bg-blue-50 dark:bg-blue-500/15 text-blue-700 dark:text-blue-400"
                                />
                                <MetricCard
                                    icon={DollarSign}
                                    label="Ad Spend"
                                    ...
                                    iconColor="bg-purple-50 dark:bg-purple-500/15 text-purple-700 dark:text-purple-400"
                                />
                                <MetricCard
                                    icon={BarChart3}
                                    label="ROAS"
                                    ...
                                    iconColor="bg-emerald-50 dark:bg-emerald-500/15 text-emerald-700 dark:text-emerald-400"
                                />
                            </div>
